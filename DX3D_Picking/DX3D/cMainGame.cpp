...
void cMainGame::Setup_PickingObj()
{
	...
	m_stMtlPicked.Ambient  = D3DXCOLOR(0.7f, 0.0f, 0.7f, 1.0f);
	m_stMtlPicked.Diffuse  = D3DXCOLOR(0.7f, 0.0f, 0.7f, 1.0f);
	m_stMtlPicked.Specular = D3DXCOLOR(0.7f, 0.0f, 0.7f, 1.0f);
